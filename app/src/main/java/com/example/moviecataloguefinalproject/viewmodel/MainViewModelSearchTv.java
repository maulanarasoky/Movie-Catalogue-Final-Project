...
public class MainViewModelSearchTv extends ViewModel {
    ...
    public void setData(String language, String tvShowName) {
        AsyncHttpClient client = new AsyncHttpClient();
        final ArrayList<ListData> data = new ArrayList<>();
        String url = " https://api.themoviedb.org/3/search/tv?api_key=" + API_KEY + "&language=" + language + "-US&query=" + tvShowName;
