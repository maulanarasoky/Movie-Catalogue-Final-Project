package com.example.moviecataloguefinalproject.viewmodel;
...
public class MainViewModelSearchMovie extends ViewModel {
    ...
    public void setData(String language, String movieName) {
        AsyncHttpClient client = new AsyncHttpClient();
        final ArrayList<ListData> data = new ArrayList<>();
        String url = "https://api.themoviedb.org/3/search/movie?api_key=" + API_KEY +"&language=" +language + "&query=" + movieName;
